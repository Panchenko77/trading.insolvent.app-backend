...
impl GateioTimeInForce {
    pub fn from_tif_and_order_type(tif: TimeInForce, ty: OrderType) -> Self {
        ...
        match tif {
            ...
            TimeInForce::Day => GateioTimeInForce::day,
            TimeInForce::GoodTilDate => GateioTimeInForce::gtd,
            TimeInForce::PendingOrCancel => GateioTimeInForce::poc,
            _ => unreachable!("GoodTilCrossing is not supported"),
        }
    }
}
impl From<GateioTimeInForce> for TimeInForce {
    fn from(tif: GateioTimeInForce) -> Self {
        match tif {
            GateioTimeInForce::gtc => TimeInForce::GoodTilCancel,
            GateioTimeInForce::ioc => TimeInForce::ImmediateOrCancel,
            // FIXME: properly support PendingOrCancel
            GateioTimeInForce::poc => TimeInForce::GoodTilCancel,
            GateioTimeInForce::fok => TimeInForce::FillOrKill,
            GateioTimeInForce::gtt => TimeInForce::GoodTilTime,
            GateioTimeInForce::day => TimeInForce::Day,
            GateioTimeInForce::gtd => TimeInForce::GoodTilDate,
        }
    }
}
...
impl From<GateioOrderStatus> for OrderStatus {
    fn from(status: GateioOrderStatus) -> Self {
        match status {
            GateioOrderStatus::open => OrderStatus::Open,
            GateioOrderStatus::closed => OrderStatus::Filled,
            GateioOrderStatus::cancelled => OrderStatus::Cancelled,
        }
    }
}
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
...
impl From<GateioOrderType> for OrderType {
    fn from(ty: GateioOrderType) -> Self {
        match ty {
...
#[serde_as]
#[derive(Serialize, Deserialize)]
pub struct PerpetualHttpOpenOrder {
    pub id: u64,
    // pub user: i64,
    pub contract: Symbol,
    pub create_time: f64,
...
pub fn gateio_decode_http_open_orders(
    account: AccountId,
    data: &[u8],
    exchange: Exchange,
    ...
    match exchange {
        ...
        Exchange::GateioPerpetual => {
            let orders: Vec<PerpetualHttpOpenOrder> = serde_json::from_slice(data)?;
...
#[serde_as]
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq)]
pub struct GateioSpotNewOrderResponse {
    pub id: OrderSid,
