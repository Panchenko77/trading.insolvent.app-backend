...
#[derive(Clone)]
pub struct MethodUserGetSymbol2 {
    pub table_symbol_flag: Table<SharedSledStorage, DbRowSymbolFlag>,
}
#[async_trait(?Send)]
impl RequestHandler for MethodUserGetSymbol2 {
    type Request = build::model::UserGetSymbol2Request;
    ...
    async fn handle(&self, ctx: RequestContext, req: Self::Request) -> Response<Self::Request> {
        ...
        Ok(build::model::UserGetSymbol2Response {
