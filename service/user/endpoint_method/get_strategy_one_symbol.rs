...
#[derive(Clone)]
pub struct MethodUserGetStrategyOneSymbol {
    pub table_symbol_flag: Table<SharedSledStorage, DbRowSymbolFlag>,
}
#[async_trait(?Send)]
impl RequestHandler for MethodUserGetStrategyOneSymbol {
    type Request = build::model::UserGetStrategyOneSymbolRequest;
    ...
    async fn handle(&self, ctx: RequestContext, req: Self::Request) -> Response<Self::Request> {
        ...
        Ok(build::model::UserGetStrategyOneSymbolResponse {
